...
filename_queue = tf.train.string_input_producer(['/home/szaman5/Phytoplankton_Classifier/data/train.tfrecords'],num_epochs=1)   
_, serialized_example = reader.read(filename_queue)

feature = {'train/label':tf.FixedLenFeature([len(classes)],tf.float32),\
...
image = tf.reshape(image,[254,254,3])
...
#    print(lbl)
 ...
 #   for i in range(total_iterations,
    ...
    #    msg = "Real Time:{0:.4f}, CPU Time: {1:.4f}, SYS Time: {2:.4f}"
    #    end_resources = resource_usage(RUSAGE_SELF) 
    #    print("Loading images"+msg.format((time() - start_time),(end_resources.ru_utime-start_resources.ru_utime),(end_resources.ru_stime-start_resources.ru_stime)))
    ...
    #                          keep_prob:1}
    #    print("Finished Loading images"+msg.format((time() - start_time),(end_resources.ru_utime-start_resources.ru_utime),(end_resources.ru_stime-start_resources.ru_stime)))
    #    print("Starting Sesstion"+msg.format((time() - start_time),(end_resources.ru_utime-start_resources.ru_utime),(end_resources.ru_stime-start_resources.ru_stime)))
        #session.run(optimizer, feed_dict=feed_dict_tr)
    #    print("Finishing Sesstion"+msg.format((time() - start_time),(end_resources.ru_utime-start_resources.ru_utime),(end_resources.ru_stime-start_resources.ru_stime)))
